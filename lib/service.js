...
class Service {
  ...
  find (params) {
    ...
    let shouldCount = false // !!paginate.default
    if (params && params.query) {
      if (params.query._count === false || params.query._count === 'false') { shouldCount = false }
      delete params.query._count
    }
    const result = this._find(params, shouldCount,
